const codeBlocks=document.querySelectorAll(".highlight"),iconTick=`
...
<svg version="1.1" height="20px" width="20px"
    viewBox="0 0 32 32" xml:space="preserve" fill="#d3d3d3">
    <g id="SVGRepo_iconCarrier">
...
`;codeBlocks.forEach(e=>{const t=e.querySelector(".copy-btn"),s=e.querySelector("pre").classList.contains("non-lang"),n=e.querySelector("code");t.addEventListener("click",()=>{let e=n.innerText;s||(e=n.innerText.split(`
`).filter((e,t)=>t%2==0).join(`
`)),navigator.clipboard.writeText(e),t.innerHTML=iconTick,setTimeout(()=>t.innerHTML=iconCopy,3e3)})})