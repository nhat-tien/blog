let $toggleButton=document.querySelector("#toggle-theme-button");setIconDependCurrentTheme();function setIconDependCurrentTheme(){const e=sessionStorage.getItem("theme");switch(e){case"light":changeIconTheme("day",$toggleButton);break;case"dark":changeIconTheme("night",$toggleButton);break;case"system":changeIconTheme("system",$toggleButton);break}}function toggleOpen(){const e=document.querySelector(".theme-selector");e.classList.contains("show")?(e.style.animationName="hide-theme-selector",setIconDependCurrentTheme(),setTimeout(()=>{e.classList.remove("show")},100)):(e.style.animationName="show-theme-selector",changeIconTheme("hide",$toggleButton),setTimeout(()=>{e.classList.add("show")},100))}function setTheme(e){let t=document.querySelector("html");switch(e){case"light":t.classList.remove("dark-theme"),sessionStorage.setItem("theme","light");break;case"dark":t.classList.add("dark-theme"),sessionStorage.setItem("theme","dark");break;case"system":const e=isSystemPreferDarkTheme();e?t.classList.add("dark-theme"):t.classList.remove("dark-theme"),sessionStorage.setItem("theme","system");break}}function changeIconTheme(e,t){e=="day"?t.innerHTML=`
